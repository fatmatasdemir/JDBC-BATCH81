 ...
 */
   ...
   //1. Örnek: İki parametre ile çalışıp bu parametreleri toplayarak return yapan bir fonksiyon oluşturun..
        ...
        cst1.execute();
        // CST ===>> CallableStatement kisaltilmis hali
        // 6.Adim:sinucu cagurmak icin return data tipine gore " get " methodlarindan uygun olani kullan.
        ...
        cst2.setInt(2,1);  // 1 yerine baska rakam verebiliriz yukardaki ? isareti dinamik yapti
        cst2.setInt(3,1);
